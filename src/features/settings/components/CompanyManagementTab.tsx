    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-end justify-between gap-4">
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="pb-1">
            <p className="text-lg font-bold text-black dark:text-white">Codevera</p>
            <p className="text-sm text-[#808080]">Codevera1234@gmail.com</p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-5 rounded-2xl border border-white bg-linear-to-br from-white/35 from-65% to-[#D9FFFA]/50 p-3 md:p-6 dark:border-white/10 dark:bg-linear-to-br dark:from-white/5 dark:from-65% dark:to-[#D9FFFA]/50/15">
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            <UploadField label={s.companyLogoLabel} />
          </div>
          <div className="sm:col-span-2">
            <UploadField label={s.commercialRegisterLabel} />
          </div>
          <div className="sm:col-span-2">
            <UploadField label={s.taxCardLabel} />
          </div>
