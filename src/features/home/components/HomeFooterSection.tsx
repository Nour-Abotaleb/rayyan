            ...
            <div className="mt-3 flex items-center gap-2">
              ...
              >
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2.8125 15.75C2.502 15.75 2.25 15.498 2.25 15.1875V2.8125C2.25 2.502 2.502 2.25 2.8125 2.25H15.1875C15.498 2.25 15.75 2.502 15.75 2.8125V15.1875C15.75 15.498 15.498 15.75 15.1875 15.75H2.8125Z" stroke="white" strokeWidth="1.125" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M8.4375 7.875V12.375" stroke="white" strokeWidth="1.125" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M6.1875 7.875V12.375" stroke="white" strokeWidth="1.125" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M8.4375 9.84375C8.4375 8.75625 9.31875 7.875 10.4062 7.875C11.4938 7.875 12.375 8.75625 12.375 9.84375V12.375" stroke="white" strokeWidth="1.125" stroke-linecap="round" stroke-linejoin="round"/>
              ...
              >
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M3.375 2.8125H6.75L14.625 15.1875H11.25L3.375 2.8125Z" stroke="white" strokeWidth="1.125" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M8.007 10.0918L3.375 15.1873" stroke="white" strokeWidth="1.125" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M14.6249 2.8125L9.99292 7.908" stroke="white" strokeWidth="1.125" stroke-linecap="round" stroke-linejoin="round"/>
                  </g>
                  <defs>
