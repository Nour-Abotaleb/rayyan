  ...
  return (
    <section className="pt-12 pb-10 md:pt-16 md:pb-14">
      <div className="mx-auto flex w-[95%] md:max-w-5xl flex-col items-center text-center">
        ...
        <div className="relative mt-16 w-full min-h-[345px] overflow-hidden rounded-[24px] border border-transparent bg-[#F2F2F2] p-2.5 sm:min-h-0 sm:p-4 md:mt-2 md:p-6 dark:border-white/10 dark:bg-[#141414]">
          ...
          <div className="absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 items-center justify-center gap-2 rounded-full bg-[#AFAFAF]/25 p-1.5 md:bottom-6 dark:bg-white/10">
            {filterKeys.map((key) => (
              <button
                key={key}
                type="button"
                onClick={() => setActiveFilter(key)}
                className={`rounded-full px-2 py-[7.9px] text-xs font-semibold transition md:px-4 md:py-[9.9px] ${
                  activeFilter === key
