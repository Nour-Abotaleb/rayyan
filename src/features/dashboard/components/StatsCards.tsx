  ...
  return (
    ...
    >
      ...
      <div className="col-span-2 row-start-2 md:col-span-1 md:col-start-1 md:row-start-2">
        <p className="text-base md:text-[18px] lg:text-[20px] font-medium leading-snug text-black/80 dark:text-white/80">
          {label}
        </p>
        <p className="mt-0.5 text-sm md:text-base text-black/60 dark:text-white/60 font-medium">
          {sub}
        </p>
      </div>
    </div>
