    ...
    <div className="relative flex min-h-0 flex-1 flex-col items-stretch overflow-x-clip bg-screen dark:bg-screen-dark lg:min-h-[calc(100dvh-4.5rem)] lg:flex-row lg:items-stretch lg:overflow-x-visible lg:overflow-y-visible">
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-[9999] flex justify-center">
        <Image
          ...
          alt=""
          aria-hidden="true"
          className="h-auto w-full max-w-[900px] object-contain mix-blend-multiply dark:mix-blend-screen dark:opacity-10"
          priority
        />
      </div>
      ...
      <div className="relative z-0 w-full ps-6 pt-1.5 lg:w-[45%]">
        <section className="flex w-full flex-col rounded-2xl border border-white dark:border-zinc-800 bg-gradient-to-br from-white/40 from-[35%] to-[#D1E4E2]/50 dark:from-zinc-900 dark:to-zinc-900/80 lg:w-[calc(100%+2.5rem)] lg:max-w-none">
          <LoginForm />
        </section>
      </div>
