  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col items-stretch overflow-x-clip bg-screen pb-6 dark:bg-screen-dark md:min-h-[calc(100dvh-4.5rem)] md:flex-1 lg:flex-row lg:items-stretch lg:overflow-x-visible lg:overflow-y-visible lg:pb-0">
      ...
      <div className="relative z-0 w-full shrink-0 p-2 md:px-6 md:pb-0 md:pt-1.5 lg:w-[45%] lg:px-0 lg:ps-6 lg:pt-1.5">
        <section className="flex min-h-min w-full flex-col rounded-2xl border border-white bg-linear-to-br from-white/35 from-65% to-[#D9FFFA]/50 dark:border-white/10/30 dark:bg-linear-to-br dark:from-white/5 dark:from-65% dark:to-[#D9FFFA]/50/15 lg:w-[calc(100%+2.5rem)] lg:max-w-none">
          <SignUpForm />
        </section>
      </div>
