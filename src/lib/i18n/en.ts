const en = {
  ...
  dashboard: {
    ...
    overview: {
      ...
      promptTitle: "Enter Project Details For Your Proposal",
      promptPlaceholder: "Describe your project, goals, and any specific requirements here...",
      typesTechnical: "Technical",
      typesFinancial: "Financial",
      typesVisualization: "Visualization",
    },
    leftPanel: {
    ...
    proposalDetailsModal: {
      ...
      subtitle: "Add the core information and requirements to build your proposal",
      rfpLabel: "RFP",
      ...
      sectorIndustryPlaceholder: "Select proposal sector",
