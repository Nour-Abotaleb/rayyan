const ar = {
  ...
  dashboard: {
    ...
    financialProposal: {
      readiness: {
        title: "قبل المتابعة،",
        subtitle: "يرجى الإجابة على الأسئلة التالية بصدق. تحتاج إلى الحصول على 6/7 على الأقل للمتابعة في إنشاء العرض.",
        checkBtn: "تحقق من الاستعداد",
        questions: [
          "لقد قرأت وفهمت نطاق العمل",
          "هذا المشروع ضمن صلاحياتنا",
          "لقد تنسقت داخلياً للقيام بالتسعير",
          "نوع العقد مفهوم (ثابت، قائم على المخرجات، أو إطاري)",
          "لقد تحققت من وجود بطاقة أسعار أو عرض مماثل سابق",
          "أفهم ما إذا كان هذا جدول كميات شهرياً للموارد أم قائماً على المراحل",
          "أعرف المدة المتوقعة للمشروع أو الاتفاقية",
        ] as const,
        failTitle: "غير مستعد بعد",
        failMessage: "تحتاج إلى تحديد 6 من أصل 7 عناصر على الأقل للمتابعة. يرجى مراجعة القائمة والمحاولة مرة أخرى.",
        tryAgain: "حاول مجدداً",
      },
      sidebar: {
        title: "إنشاء مقترح مالي",
        description: "أضف تفاصيل مشروعك ودع النظام يبني مقترحاً مالياً متكاملاً.",
        stepCompletedAriaPrefix: "الخطوة",
        stepCompletedAriaSuffix: "مكتملة",
      },
      steps: {
        projectInfoTitle: "معلومات المشروع",
        projectInfoSubtitle: "حدد التفاصيل الأساسية وأهداف المشروع.",
        deliverablesTitle: "المخرجات وتخطيط التكاليف",
        deliverablesSubtitle: "خطط للمراحل وجدول التسليم.",
        paymentTermsTitle: "شروط الدفع",
        paymentTermsSubtitle: "عيّن الأدوار وأبرز المهارات.",
        finalReviewTitle: "المراجعة النهائية",
        finalReviewSubtitle: "راجع المقترح وصدّره.",
      },
      form: {
        rfpDocumentsLabel: "وثائق طلب العروض",
        clientNameLabel: "اسم العميل",
        clientNamePlaceholder: "مثال: أحمد عادل",
        projectNameLabel: "اسم المشروع",
        projectNamePlaceholder: "أدخل اسم مشروعك",
        numDeliverablesLabel: "عدد المخرجات",
        numDeliverablesPlaceholder: "0",
        boqTypeLabel: "نوع جدول الكميات",
        boqTypePlaceholder: "اختر نوع جدول الكميات",
        projectTypeLabel: "نوع المشروع",
        projectTypePlaceholder: "اختر نوع المشروع",
        sectorIndustryLabel: "القطاع/المجال",
        sectorIndustryPlaceholder: "مثال: الإنشاءات",
        proposalLanguageLabel: "لغة المقترح",
        taxConfigLabel: "إعدادات الضريبة",
        taxRatePlaceholder: "نسبة الضريبة %",
        startDateLabel: "تاريخ البدء",
        endDateLabel: "تاريخ الانتهاء",
        datePlaceholder: "مثال: mm/dd/yyyy",
        termsLabel: "الشروط والأحكام",
        termsPlaceholder: "أدخل الشروط والأحكام...",
        optionalLabel: "اختياري",
      },
      actions: {
        prevReadiness: "السابق: تقييم الاستعداد",
        nextDeliverables: "التالي: المخرجات وتخطيط التكاليف",
        prevProjectInfo: "السابق: معلومات المشروع",
        nextPaymentTerms: "التالي: شروط الدفع",
        prevDeliverables: "السابق: المخرجات وتخطيط التكاليف",
        nextFinalReview: "التالي: المراجعة النهائية",
        prevPaymentTerms: "السابق: شروط الدفع",
        openAriaLabel: "فتح الخيارات",
      },
      step2Form: {
        serviceCatalogLabel: "كتالوج الخدمات",
        serviceCatalogPlaceholder: "اختر كتالوج الخدمات",
        deliverableNameLabel: "اسم المخرج",
        deliverableNamePlaceholder: "مثال: أحمد عادل",
        dueDateLabel: "تاريخ الاستحقاق",
        dueDatePlaceholder: "mm/dd/yyyy",
        quantityLabel: "الكمية",
        quantityPlaceholder: "أدخل اسم مشروعك",
        unitPriceLabel: "سعر الوحدة (ر.س)",
        unitPricePlaceholder: "اختر قطاع المقترح",
        salaryCostsLabel: "تكاليف الرواتب (ر.س)",
        salaryCostsPlaceholder: "اختر قطاع المقترح",
        toolsCostsLabel: "تكاليف الأدوات/البرمجيات (ر.س)",
        toolsCostsPlaceholder: "اختر قطاع المقترح",
        otherExpensesLabel: "مصروفات أخرى (ر.س)",
        otherExpensesPlaceholder: "اختر قطاع المقترح",
      },
      step3Form: {
        addPaymentTerm: "إضافة شرط دفع",
        paymentDescLabel: "وصف الدفعة",
        paymentDescPlaceholder: "مثال: أحمد عادل",
        percentageLabel: "النسبة المئوية (%)",
        percentagePlaceholder: "اختر قطاع المقترح",
      },
    },
    newProposal: {
      steps: {
    ...
    settings: {
      ...
      billingPlans: {
        ...
        ctaCurrentPlan: "الباقة الحالية",
        ctaSelect: "اختيار الباقة",
